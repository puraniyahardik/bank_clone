  ...
  return (
      <section className={`${styles.flexCenter} ${styles.marginY} ${styles.padding} sm:flex-row flex-col dark:bg-black-gradient-2 rounded-[20px] box-shadow`}>
        <div className='flex-1 flex flex-col'>
          ...
          <p  className={`${styles.paragraph} max-w-[470px] mt-5`}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Enim nobis fugiat animi, sunt aspernatur eveniet repellendus voluptatem ea esse quod!</p>
        </div>
